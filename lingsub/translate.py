...
from lingsub.agents import ChunkedTranslatorAgent, ContextReviewerAgent
from lingsub.context import TranslateInfo, TranslationContext
from lingsub.exceptions import ChatBotException
from lingsub.models import ModelConfig
from lingsub.prompt import AtomicTranslatePrompter
...
class LLMTranslator(Translator):
    ...
    def __init__(self, chatbot_model: Union[str, ModelConfig] = 'deepseek-chat', fee_limit: float = 0.8,
